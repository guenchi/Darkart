...
(newline)
(display (py/long-check? (int 7)))
(newline)
(display (py/long-check? (float 7.0)))
(newline)
(display (py/float-check? (float 7.0)))
(newline)
(display (py/float-check? (int 7)))
(newline)
(display (py/list-check? (list->plist 'int '(1 2 3 4 5 6))))
(newline)
(display (py/list-check? (list->ptuple 'int '(1 2 3 4 5 6))))
(newline)
(display (py/tuple-check? (list->ptuple 'int '(1 2 3 4 5 6))))
(newline)
(display (py/tuple-check? (list->plist 'int '(1 2 3 4 5 6))))
(newline)
(display (py/sequence-check? (list->plist 'int '(1 2 3 4 5 6))))
(newline)
(display (py/dict-check? (alist->pdict 'int `((a . 1)(b . 2)))))
(newline)
(display (py/dict-check? (list->plist 'int '(1 2 3 4 5 6))))
(newline)
(display (py/mapping-check? (alist->pdict 'int `((a . 1)(b . 2)))))
(newline)
(display (py/mapping-check? (list->plist 'int '(1 2 3 4 5 6))))
(newline)
